...
def main():
	...
	# Create CFG and DDG
	cfg = p.analyses.CFGEmulated(keep_state=True, state_add_options=angr.sim_options.refs, context_sensitivity_level=2, iropt_level=0)
	...
	custom_irsb = pyvex.IRSB.empty_block(p.arch, 0x500000, statements=slice_stmts, size=len(slice_stmts))
